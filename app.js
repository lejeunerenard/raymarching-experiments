...
export default class App {
  constructor (options = {}) {
    ...
    const preset = {
      ...
      d: 5,
      scale: 1.88,
      rot2angle: [0.017, 0.259, 0],
      cameraAngles: [-0.203, -0.009, 0]
    }
    preset.cameraAngles = [0, 0, 0]

    this.d = preset.d
    this.cameraRo = vec3.fromValues(0, 0, 4.7)
    this.offsetC = [0.339, -0.592, 0.228, 0.008]

    // Ray Marching Parameters
    this.epsilon = preset.epsilon || 0.000003
  ...
  setupAnimation (preset) {
    ...
    offsetTween1
      .to([ this.offset[0], 1.111, this.offset[2] ], 40 * 1000)
      .easing(TWEEN.Easing.Quadratic.InOut)

...
export default class App {
  constructor (options = {}) {
    ...
    const preset = {
      ...
      d: 0.52,
      scale: 1.2204,
      rot2angle: [3.077, 2.869, 4.255],
      cameraAngles: [0, 0.001, 0]
    }

    this.d = preset.d
    this.cameraRo = vec3.fromValues(-1, 0.6, 2)
    this.offsetC = [0.339, -0.592, 0.228, 0.008]

    this.colors1 = [240, 240, 121]
  ...
  setupAnimation (preset) {
    ...
    rotTween1
      .to([3.077, this.rot2angle[1], this.rot2angle[2]], 5 * 1000)
      .easing(TWEEN.Easing.Quadratic.InOut)
    let rotTween2 = new TWEEN.Tween(this.rot2angle)
    rotTween2
      .to([2.661, 3.216, this.rot2angle[2]], 5 * 1000)
      .easing(TWEEN.Easing.Quadratic.InOut)

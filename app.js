...
export default class App {
  constructor (options = {}) {
    ...
    const preset = {
      ...
      d: 0.52,
      scale: 1.5892,
      rot2angle: [0.351, 2.656, 0],
      cameraAngles: [-0.028, 0.314, 0.083]
    }

    this.d = preset.d
    this.cameraRo = vec3.fromValues(0, 0.04, 1.29)
    ...
    this.epsilon = preset.epsilon || 0.00005
    ...
    this.loaded = Promise.resolve()
      // .then(() => {
      //   const { glsl, metadata } = convert(require('./hidden.svg.js'))
